...
namespace Test.Holdem.Statistics
{
    ...
    public class TestPotOdds
    {
        ...
        public void PotOdds_TurnOrRiverProbability()
        {
            ...
            odds.TurnOrRiverProbability(handInfo).Should().BeGreaterOrEqualTo(value);
        }
        ...
        public void PotOdds_TurnProbability()
        {
            ...
            var prob = odds.RoundWithScale(handInfo .NumberOfOuts * PotOdds.TurnRatio, odds.Precision);

            odds.TurnProbability(handInfo).Should().BeGreaterOrEqualTo(prob);
        }
        ...
        [Test]
        public void PotOdds_RiverProbability()
        {
            var odds = new PotOdds();
            var handInfo =
                new HandConfigOptions
            ...
            var prob = odds.RoundWithScale(handInfo.NumberOfOuts * PotOdds.RiverRatio, odds.Precision);

            odds.RiverProbability(handInfo).Should().BeGreaterOrEqualTo(prob);
        }
        ...
        public void PotOdds_CalculatePokerOddsAsProbability_Turn()
        {
            ...
            var result = odds.TurnProbability(handInfo);
        ...
        public void PotOdds_CalculatePokerOddsAsProbability_River()
        {
            ...
            var result = odds.RiverProbability(handInfo);
        ...
        public void PotOdds_CalculatePokerOddsAsProbability_Combined()
        {
            ...
            var result = odds.TurnOrRiverProbability(handInfo);
        ...
        public void PotOdds_CalculatePokerOddsAsRatio_Turn()
        {
            ...
            var result = odds.RoundWithScale((1/value) - 1, handInfo.Precision);

            odds.CalculatePokerOddsAsRatio(handInfo).Should().BeGreaterOrEqualTo(result);
        }
        ...
        public void PotOdds_RunnerRunnerAsRatio()
        {
            ...
            var expected = odds.RoundWithScale(ratio - 1, handInfo.Precision);

            odds.RunnerRunnerAsRatio(handInfo).Should().BeGreaterOrEqualTo(expected);
        }
