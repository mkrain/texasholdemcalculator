...
namespace TexasHoldemCalculator.Core.Controls
{
    ...
    public class CircularProgressBarViewModel : FrameworkElement, INotifyPropertyChanged
    {
        ...
        public double Diameter
        {
            ...
            set { this._diameter = value; this.OnPropertyChanged("Diameter"); }
        }

        public double Radius
        {
            get { return this._radius; }
            set { this._radius = value; this.OnPropertyChanged("Radius"); }
        }

        public double InnerRadius
        {
            get { return this._innerRadius; }
            set { this._innerRadius = value; this.OnPropertyChanged("InnerRadius"); }
        }

        public double CentreX
        {
            get { return this._centreX; }
            set { this._centreX = value; this.OnPropertyChanged("CentreX"); }
        }

        public double CentreY
        {
            get { return this._centreY; }
            set { this._centreY = value; this.OnPropertyChanged("CentreY"); }
        }

        public double Angle
        {
            get { return this._angle; }
            set { this._angle = value; this.OnPropertyChanged("Angle"); }
        }

        public double HoleSizeFactor
        {
            get { return this._holeSizeFactor; }
            set { this._holeSizeFactor = value; this.ComputeViewModelProperties(); }
        }
